...
public interface Ai {
	 ...
	 * @param timeoutPair a pair of Long and TimeUnit used to notify the AI how long
	 *                    it has to make a decision before
	 *                    its turn has ended. Where the Long is the duration and the
	 *                    TimeUnit is the unit of time
	 *                    e.g. (milliseconds, seconds, etc...)
	 * @return a correct move from {@link Board#getAvailableMoves()} in the game
	 *         board
	 */
	@Nonnull
