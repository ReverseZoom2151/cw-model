...
public interface Board {
	 ...
	 * @return the location of the given detective; empty if the detective is not
	 *         part of the game
	 */
	@Nonnull
	 ...
	 * @return the ticket board of the given player; empty if the player is not part
	 *         of the game
	 */
	@Nonnull
	...
	/**
	 * Represents an on-going ScotlandYard game where moves by each player advances
	 * the game.
	 */
