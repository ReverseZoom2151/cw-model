...
public interface Model {
	...
	/**
	 * Registers an observer to the model. It is an error to register the same
	 * observer more than
	 * once.
	 *
	...
	/**
	 * Unregisters an observer to the model. It is an error to unregister an
	 * observer not
	 ...
	 */
	@Nonnull
	ImmutableSet<Observer> getObservers();
