 ...
 * Each player contains the {@link Piece} (coloured counter), {@link Ticket}s,
 * and the location.
 */
public final class Player {
	 ...
	 */
	@Nonnull
	public Player give(@Nonnull Iterable<Ticket> tickets) {
		var x = this;
	 ...
	 */
	@Nonnull
	public Player give(@Nonnull Ticket ticket) {
	 ...
	 */
	@Nonnull
	public Player use(@Nonnull Iterable<Ticket> tickets) {
		var x = this;
		for (Ticket t : tickets)
			x = x.use(t);
		return x;
	 ...
	 */
	@Nonnull
	public Player use(@Nonnull Ticket ticket) {
		if (!has(ticket))
	 ...
	 */
	@Nonnull
	public Player at(int newLocation) {
		return new Player(piece, tickets, newLocation);
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(piece, tickets, location);
	}

	@Override
	public String toString() {
		return piece + "@" + location + "(" + tickets + ")";
	}
}
