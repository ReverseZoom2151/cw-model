...
public final class ScotlandYard {
	...
	public static final Comparator<Piece> PIECE_VALUE_ORDER = Comparator.comparingInt(ALL_PIECES::indexOf);

	/**
	 * Reveal rounds for a 24 round game
	 */
	public static final ImmutableSet<Integer> REVEAL_ROUND = ImmutableSet.of(3, 8, 13, 18, 24);

	/**
	 * All possible initial locations for detectives
	 */
	public static final ImmutableList<Integer> DETECTIVE_LOCATIONS = ImmutableList.of(26, 29, 50, 53, 91, 94, 103, 112,
			117, 123, 138, 141, 155, 174);

	/**
	 * All possible initial locations for Mr.X
	 */
	public static final ImmutableList<Integer> MRX_LOCATIONS = ImmutableList.of(35, 45, 51, 71, 78, 104, 106, 127, 132,
			166, 170, 172);
	 ...
	 */
	public static final ImmutableSet<Ticket> MRX_TICKETS = ImmutableSet.copyOf(EnumSet.allOf(Ticket.class));
	 ...
	 */
	@Nonnull
	public static ImmutableList<Integer> generateDetectiveLocations(int seed, int n) {
	 ...
	 */
	@Nonnull
	public static ImmutableMap<Ticket, Integer> defaultMrXTickets() {
	 ...
	 */
	@Nonnull
	public static ImmutableMap<Ticket, Integer> defaultDetectiveTickets() {
		return ImmutableMap.of(
				Ticket.TAXI, 11,
				Ticket.BUS, 8,
	...
	@Nonnull
	public static ImmutableMap<Integer, Entry<Integer, Integer>> pngMapPositionEntries() throws IOException {
	...
	@Nonnull
	public static ImmutableValueGraph<Integer, ImmutableSet<Transport>> standardGraph() throws IOException {
		return readGraph(Resources.toString(
				Resources.getResource("graph.txt"), StandardCharsets.UTF_8));
	}

	@Nonnull
	public static ImmutableValueGraph<Integer, ImmutableSet<Transport>> readGraph(@Nonnull String content) {
		...
		MutableValueGraph<Integer, ImmutableSet<Transport>> graph = ValueGraphBuilder.undirected()
	...
	public interface Factory<T> {
		/**
		 * Create an instance of the parameterised type given the parameters required
		 * for
		 * ScotlandYard game
		 *
		 ...
		 */
		@Nonnull
		T build(GameSetup setup, Player mrX, ImmutableList<Player> detectives);

		/**
		 * Delegates to {@link #build(GameSetup, Player, ImmutableList)}, mainly used
		 * for tests
		 ...
		 */
		@Nonnull
		default T build(GameSetup setup, Player mrX, Player first, Player... rest) {
